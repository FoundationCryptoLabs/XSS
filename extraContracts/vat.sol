...
contract Vat {
    ...
    uint256 public dust = 10000 // 10000 sats is minimum amount
    ...
    function depositCollateral() public returns(uint256 safeID){
      require(msg.value>=dust, 'vat/collateral-is-dusty');
